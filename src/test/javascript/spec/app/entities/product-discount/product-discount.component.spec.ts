...
import { ProductDiscountComponent } from 'app/entities/product-discount/product-discount.component';
...
describe('Component Tests', () => {
    describe('ProductDiscount Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.productDiscounts[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
