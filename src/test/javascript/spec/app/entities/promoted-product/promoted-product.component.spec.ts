...
import { PromotedProductComponent } from 'app/entities/promoted-product/promoted-product.component';
...
describe('Component Tests', () => {
    describe('PromotedProduct Management Component', () => {
        let comp: PromotedProductComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PromotedProductComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.promotedProducts[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
