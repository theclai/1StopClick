...
import { ProductReviewDeleteDialogComponent } from 'app/entities/product-review/product-review-delete-dialog.component';
import { ProductReviewService } from 'app/entities/product-review/product-review.service';

describe('Component Tests', () => {
    describe('ProductReview Management Delete Component', () => {
        let comp: ProductReviewDeleteDialogComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ProductReviewDeleteDialogComponent, '')
                .compileComponents();
