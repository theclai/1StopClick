...
export class ProductReviewComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.productReviewService
            ...
            .subscribe(
                (res: HttpResponse<IProductReview[]>) => this.paginateProductReviews(res.body, res.headers),
    ...
    protected paginateProductReviews(data: IProductReview[], headers: HttpHeaders) {
