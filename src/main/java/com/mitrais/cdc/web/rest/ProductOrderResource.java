...
public class ProductOrderResource {
    ...
    public ResponseEntity<List<ProductOrder>> getAllProductOrders(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, String.format("/api/product-orders?eagerload=%b", eagerload));
