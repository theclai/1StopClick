...
public class PersistentTokenRememberMeServices extends
    ...
    private final com.mitrais.cdc.repository.PersistentTokenRepository persistentTokenRepository;

    private final UserRepository userRepository;

    public PersistentTokenRememberMeServices(JHipsterProperties jHipsterProperties,
                                             org.springframework.security.core.userdetails.UserDetailsService userDetailsService,
                                             com.mitrais.cdc.repository.PersistentTokenRepository persistentTokenRepository, UserRepository userRepository) {
